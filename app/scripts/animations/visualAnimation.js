...
class VisualAnimation {
    ...
    showAll() {
        this.elements.forEach((item) => {
            ...
            if (!item.classList.contains('visual-animation-showing' + this.additionalToClass)) {
                ...
                const characters = item.querySelectorAll('.visual-animation-word' + this.additionalToClass
                    + ' > span');
    ...
    removeClasses() {
        ...
        const blockElementsShowing = document.querySelectorAll('.visual-animation-showing-block'
